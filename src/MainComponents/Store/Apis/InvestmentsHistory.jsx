...
export const InvestmentHistory = createAsyncThunk(
  "history",
  async ({ startDate, endDate, currentPage }, thunkAPI) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_URL}superadmin/investmenthistory?start_date=${formattedDate}&end_date=${formattedDated}&page=${currentPage}`,
        {
          method: "GET",
          headers: {

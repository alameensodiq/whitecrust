...
export const TransferDashboard = createAsyncThunk(
  "transferdashboard",
  async ({ endDate }, thunkAPI) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_URL}superadmin/dashboard?filter=transfer_full&month=${month}&year=${year}`,

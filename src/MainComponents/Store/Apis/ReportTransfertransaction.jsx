...
export const ReportTransfertransaction = createAsyncThunk(
  "reporttransfertransaction",
  async ({ startDatetransfertransaction }, thunkAPI) => {
    ...
    const dateObj = new Date(startDatetransfertransaction);
    ...
    try {
      // Construct the URL
      const url = new URL(
        `${process.env.REACT_APP_BASE_URL}superadmin/report?filter=transfer_transaction&month=${month}&year=${year}`
      );

...
export const Audits = createAsyncThunk(
  "audits",
  async ({ search, startDate, endDate, currentPage, download }, thunkAPI) => {
    ...
    try {
      // Construct the URL
      const url = new URL(`${process.env.REACT_APP_BASE_URL}superadmin/audit`);
